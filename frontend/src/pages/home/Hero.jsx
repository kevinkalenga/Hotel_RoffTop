    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-center md:gap-14 gap-8">
            <div className="md:w-1/2 w-full text-center">
                <h1 className="md:text-4xl text-2xl font-bold md:leading-tight">Hotels With Rooftop Pools Near Me</h1>
                <p className="py-4">
                    Discovering hotels with pools near you! whether you're planning a luxurious
                    staycation or a weekend getaway, our curated selection of hotels with rooftop
                    pools will help you beat the heat and elevate your travel experience.
                </p>
            </div>
